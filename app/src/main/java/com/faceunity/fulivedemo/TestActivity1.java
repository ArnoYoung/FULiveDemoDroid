...
import com.faceunity.fulivedemo.gles.drawer.FaceRectPoints;
...
public class TestActivity1 extends FUBaseUIActivity
    ...
    class GLRenderer implements GLSurfaceView.Renderer {
        ...
        FaceClipFrameRect faceClipFrameRect;

        FaceMarksPointsDrawer landmarksPoints;
        FaceRectPoints faceRectPoints;
        float[] landmarksData = new float[75 * 2];
        float[] faceRectData = new float[4];
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            if (true) {
                ...
                clipTextures = faceRectPoints.refreshFulll(faceRectData, cameraWidth, cameraHeight, 0.1f, 0.8f, currentCameraType != Camera.CameraInfo.CAMERA_FACING_FRONT);
                faceRectPoints.draw();
                landmarksPoints.refreshFulll(landmarksData, cameraWidth, cameraHeight, currentCameraType != Camera.CameraInfo.CAMERA_FACING_FRONT);
...
//                landmarksPoints.draw();
            ...
            if (mTextureMovieEncoder != null && mTextureMovieEncoder.checkRecordingStatus(START_RECORDING)) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(TestActivity1.this, "video file saved to "
    ...
    static class MainHandler extends Handler {
        ...
        private WeakReference<TestActivity1> mActivityWeakReference;

        MainHandler(TestActivity1 activity) {
        ...
        public void handleMessage(Message msg) {
            ...
            TestActivity1 activity = mActivityWeakReference.get();
            switch (msg.what) {
                    ...
                    try {
                        if (mEffectFileName.equals("none")) {
                            ...
                            faceunity.fuItemSetParam(mEffectItem, "rotationAngle",
                                    ((TestActivity1) mContext.get()).getCurrentCameraType()
